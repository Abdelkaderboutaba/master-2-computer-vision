const main = (container) => {
    ...
    const eyesgroupe=faceGroup.append("g")
                              .attr("transform","translate (50,30)")

    const lefteyesgroupe=eyesgroupe.append("g")
                               .attr("transform" , "translate(-15,0)")
    
    lefteyesgroupe.append("circle")
              .attr("r",5)
              .attr("fill","blue")
    
    const righteyegroupe=eyesgroupe.append("g")
                                   .attr("transform" , "translate(15,0)")



    righteyegroupe.append("circle")
                  .attr("r",5)
                  .attr("fill","blue")
    righteyegroupe.append("line")
                  .attr("x1",-7)
                  .attr("y1",-7)
                  .attr("x2",7)
                  .attr("y2",-7)
